      ...
      <div className="prose-like space-y-12" style={{ color: 'var(--color-text)', lineHeight: 1.8 }}>
        ...
        <section id="timeline">
          ...
          <ul className="text-sm space-y-1.5 mb-4 list-disc list-inside" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <li>Compile your initial guest list, since this drives your venue size</li>
          ...
          <ul className="text-sm space-y-1.5 mb-4 list-disc list-inside" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <li>Book hair and makeup artists, as they get booked out for popular dates</li>
        ...
        <section id="finalweek">
          ...
          <ul className="text-sm space-y-2 list-disc list-inside mb-6" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <li>Have all supplier payments ready, as most SA suppliers require cash or immediate EFT on the day</li>
            ...
            <li>Write your vows if you are doing personal vows, and don't leave this to the night before</li>
          </ul>
